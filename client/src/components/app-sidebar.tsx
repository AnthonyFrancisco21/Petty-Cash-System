...
import type { PettyCashFund, UserRole } from "@shared/schema";
import { getRoleLabel, getRoleVariant } from "@/lib/roleUtils";
  ...
  return (
    <Sidebar>
      ...
      <SidebarContent>
        ...
        {/* Accounting Navigation - Preparer & Approver Only */}
        ...
        {isPreparer && (
          <SidebarGroup>
            <SidebarGroupLabel>Cash Management</SidebarGroupLabel>
            <SidebarGroupContent>
              <SidebarMenu>
                {cashManagerNavItems.map((item) => (
                  <SidebarMenuItem key={item.title}>
                    <SidebarMenuButton asChild isActive={location === item.url}>
                      <Link
                        href={item.url}
