...
const fundSettingsSchema = z.object({
  imprestAmount: z
    .string()
    .min(1, "Imprest amount is required")
    .refine(
...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {isAdmin ? (
        // ADMIN SETTINGS - Technical Focus
        <>
          <Card>
            <CardHeader>
        ...
        // CASH MANAGER & APPROVER SETTINGS - Accounting Focus
        <>
          <Card>
            <CardHeader>
            ...
            <CardContent>
              {fundLoading ? (
                ...
                <Form {...fundForm}>
                  <form
                    onSubmit={fundForm.handleSubmit((data) =>
            ...
            <CardHeader className="flex flex-row items-center justify-between gap-4">
              ...
              <Dialog open={coaDialogOpen} onOpenChange={setCoaDialogOpen}>
                ...
                <DialogContent>
                  ...
                  <Form {...coaForm}>
                    <form
                      onSubmit={coaForm.handleSubmit((data) =>
                        createCoa.mutate(data)
                      )}
                      className="space-y-4"
                    >
                      <FormField
